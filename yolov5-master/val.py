...
def run(
    ...
    name="exp0",  # save to project/name
    ...
    Args:
        ...
        name (str, optional): Name of the run. Default is 'exp0'.
...
def parse_opt():
    ...
    Args:
        ...
        name (str, optional): Name of the directory to save results to. Default is 'exp0'.
    ...
    parser.add_argument("--name", default="exp0", help="save to project/name")
